...
def data_read(file_name, var_name, timesteps):
    ...
    return total_rows, total_cols, timesteps, data

def gridId_data(total_rows, total_cols, timesteps, data):
...
def launch_job(input_path, file_name, output_path, var_name, period, \
    ...
    [total_rows, total_cols, i_timesteps, data] = data_read(file_name, var_name, i_timesteps)
    end = process_time()
