...
#@profile
def data_save(number_of_subdomains, grid_id_domains, subdomain_path, i_timesteps, var_name, data):
...
def main():
    ...
    print('number of subdomains: ('+ str(number_of_subdomains) + \
          '), timeseries: ('+ str(i_timesteps) + '), Var_name: (' + var_name +')')
    ...
    start = process_time()  
    [grid_ids, data] = gridId_data(total_rows, total_cols, i_timesteps, data, AOI_mask_file)
    end = process_time()
    ...
    start = process_time() 
    data_save(number_of_subdomains, grid_id_domains, subdomain_path, i_timesteps, var_name, data)
    end = process_time()
