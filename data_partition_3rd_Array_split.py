...
subdomain_path = input_path + '/subdomains_AS/'
...
if debug:
    print('first 5 grid_id in subdomain 0 is '+ str(grid_id_domains[0][0:5]))
    print('the sizes of first five subdomains are' + str(size_of_subdomains[0:5]))
...
if debug:
    print('number of subdomains is '+ str(len(size_of_subdomains)))
    print('the size of the first 5 subdomains are '+ str(size_of_subdomains[0:5]))
...
if debug:      
    print('the first 5 values of subdomain_idx are ' + str(subdomain_idx[0:5]))

#FSDS_list = np.hsplit(FSDS,subdomain_idx[:-1])
FSDS = np.hsplit(FSDS,subdomain_idx[:-1])

if debug:      
    print('the sizes of FSDS_list are ' + str(len(FSDS_list)))
    print('the frist 5 values in subdomain #0 are '+str(FSDS_list[0][:,0:5]))
